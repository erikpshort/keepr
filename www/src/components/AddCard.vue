        ...
        <div class="modal-mask">
            <div class="modal-wrapper">
                <div class="modal-container">
                    <v-card class="orange darken-4">
                        <v-card-text>
                            <v-container fluid>
                                <v-row>
                                    <v-col xs12>
                                        <h3 class="white--text">Add your own Card to the Stack</h3>
                                    </v-col>
                                </v-row>
                                <v-row>
                                ...
                                <v-row>
                                    <v-col xs4 offset-xs4 @click="addCard">
    ...
    export default {
        ...
        methods: {
            addCard() {
                ...
                this.$root.store.actions.addCard(body)
                this.$parent.$parent.showAddCardModal = false
            }
        }
    }
